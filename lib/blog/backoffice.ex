defmodule Blog.Backoffice do
  ...
  alias Blog.Backoffice.{Admin, AdminToken, AdminNotifier}
  ...
  ## Examples
      ...
      iex> deliver_admin_update_email_instructions(admin, current_email, &url(~p"/admin/admins/settings/confirm_email/#{&1}"))
      {:ok, %{to: ..., body: ...}}
  ...
  ## Examples
      ...
      iex> deliver_admin_confirmation_instructions(admin, &url(~p"/admin/admins/confirm/#{&1}"))
      {:ok, %{to: ..., body: ...}}

      iex> deliver_admin_confirmation_instructions(confirmed_admin, &url(~p"/admin/admins/confirm/#{&1}"))
  ...
  ## Examples
      ...
      iex> deliver_admin_reset_password_instructions(admin, &url(~p"/admin/admins/reset_password/#{&1}"))
      {:ok, %{to: ..., body: ...}}
