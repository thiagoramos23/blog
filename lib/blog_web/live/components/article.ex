  ...
  def article(assigns) do
    ...
    <article class="md:grid md:grid-cols-4 md:items-baseline">
      <div class="relative flex flex-col items-start md:col-span-3 group">
        ...
        <div aria-hidden="true" class="relative z-10 flex items-center mt-4 text-sm font-medium text-teal-500">Read article<svg viewBox="0 0 16 16" fill="none" aria-hidden="true" class="w-4 h-4 ml-1 stroke-current"><path d="M6.75 5.75 9.25 8l-2.5 2.25" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg></div>
      </div>
