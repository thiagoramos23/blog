defmodule BlogWeb.Admin.AdminRegistrationLive do
  ...
  def render(assigns) do
    ...
    <div class="mx-auto max-w-sm">
      <.header class="text-center">
        ...
        <:subtitle>
          Already registered?
          <.link navigate={~p"/admin/admins/log_in"} class="font-semibold text-brand hover:underline">
            Log in
          </.link>
          to your account now.
        </:subtitle>
      ...
      <.simple_form
        ...
        action={~p"/admin/admins/log_in?_action=registered"}
        method="post"
      >
