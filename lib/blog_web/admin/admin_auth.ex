defmodule BlogWeb.Admin.AdminAuth do
  ...
  the current_admin:
      ...
      defmodule BlogWeb.PageLive do
        ...
        on_mount {BlogWeb.Admin.AdminAuth, :mount_current_admin}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{BlogWeb.Admin.AdminAuth, :ensure_authenticated}] do
  ...
  def on_mount(:ensure_authenticated, _params, session, socket) do
    ...
    if socket.assigns.current_admin do
      ...
      socket =
        ...
        |> Phoenix.LiveView.redirect(to: ~p"/admin/admins/log_in")
  ...
  def require_authenticated_admin(conn, _opts) do
    if conn.assigns[:current_admin] do
      ...
      |> redirect(to: ~p"/admin/admins/log_in")
      |> halt()
    end
  end
